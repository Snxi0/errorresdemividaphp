    ...
    <div class="container p-4">
        <form action="crudUsuario/guardarUsuarios.php" method="POST">
            ...
            <div class="form-section mb-0">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 form-floating mb-3 mb-md-0">
                        <input type="text" class="form-control custom-back" name="nombre" id="nombre"
                            placeholder="Nombre">
                        <label for="nombre"><i class="bi bi-person-fill"></i> Nombre</label>
                        <div class="invalid-feedback d-block" id="nombre-error"></div>
                    </div>
                    <div class="col-md-6 form-floating">
                        <input type="text" class="form-control custom-back" name="apellido" id="apellido"
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control custom-back" name="cedula" id="cedula"
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control custom-back" name="telefono" id="telefono"
                ...
                <div class="form-floating mb-3">
                    <input type="date" class="form-control custom-back" name="fechaNacimiento" id="fechaNacimiento"
            ...
            <div class="form-section pt-0 mb-0 pb-3">
                ...
                <div class="form-floating mb-3">
                    <input type="password" class="form-control custom-back" name="password" id="password"
                ...
                <div class="form-floating mb-3">
                    <select class="form-select custom-back" name="rol" id="inputGroupSelect02">
                        <option value="" selected>Elige</option>
                        <option value="1">Administrador</option>
                        <option value="2">Cajero</option>
                    </select>
                    <label for="inputGroupSelect02"><i class="bi bi-person-gear"></i> Rol</label>
                </div>
            </div>

            <div class="text-center">
                <button type="submit" name="guardarUsuario" class="btn btn-warning text-dark fw-bold custom-bt w-100 w-md-auto">
